        ...
        <div class="container">
            ...
            <div class="ve-services-grid">
                @forelse ($services as $service)
                    <div class="ve-service-card wow fadeInUp" data-wow-delay="{{ min(($loop->iteration * 100), 1000) }}ms">
                        @if ($service->image)
                        ...
                        <a href="{{ route('contact') }}" class="ve-card-link">Request quote <i class="fa fa-long-arrow-right"></i></a>
                    </div>
                @empty
                    <div class="ve-service-card ve-service-empty">
                        ...
                        <p>Our CMS services are being prepared. Please contact us for current support options.</p>
