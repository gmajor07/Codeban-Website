...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Create Codeban service.">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>Add Service - Codeban CMS</title>
...
<body class="ve-cms-body">
    ...
    <main class="ve-cms-main">
        ...
        <section class="ve-cms-form-panel">
            <form action="{{ route('cms.services.store') }}" method="post" enctype="multipart/form-data" class="ve-cms-settings-form">
                @csrf
