<div class="ve-cms-form-grid">
    ...
    <div class="ve-cms-field ve-cms-field-wide"><label for="image">Client Image</label><input id="image" name="image" type="file" accept="image/*" data-image-preview="testimonial-image-preview"><div id="testimonial-image-preview" class="ve-cms-image-preview {{ $testimonial->image ? '' : 'is-hidden' }}" @if ($testimonial->image) style="background-image:url({{ asset($testimonial->image) }});" @endif></div></div>
</div>
