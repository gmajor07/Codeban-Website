...
<head>
    ...
    <title>Edit Client - Codeban CMS</title>
...
<body class="ve-cms-body">
    <aside class="ve-cms-sidebar">
        ...
        <nav class="ve-cms-nav">
            ...
            <a href="{{ route('cms.clients.index') }}" class="active"><i class="fa fa-users"></i> Clients</a>
    ...
    <main class="ve-cms-main">
        <header class="ve-cms-topbar"><div><span class="ve-section-tag">Clients</span><h1>Edit Client</h1></div><div class="ve-cms-actions"><a href="{{ route('cms.clients.index') }}" class="ve-cms-view-site"><i class="fa fa-arrow-left"></i> Back</a></div></header>
        @if ($errors->any())<div class="ve-cms-alert">{{ $errors->first() }}</div>@endif
        <section class="ve-cms-form-panel"><form action="{{ route('cms.clients.update', $client) }}" method="post" enctype="multipart/form-data">@csrf @method('PUT') @include('cms.clients.form')</form></section>
    </main>
</body>
</html>
