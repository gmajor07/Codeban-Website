<div class="ve-cms-form-grid">
    ...
    <div class="ve-cms-field ve-cms-field-wide"><label for="logo">Client Logo</label><input id="logo" name="logo" type="file" accept="image/*">@if ($client->logo)<div class="ve-cms-image-preview" style="background-image:url({{ asset($client->logo) }});"></div>@endif</div>
</div>
