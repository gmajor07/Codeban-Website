...
<body class="ve-cms-body">
    ...
    <main class="ve-cms-main">
        ...
        <section class="ve-cms-form-panel">
            <form action="{{ route('cms.about-sections.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="ve-cms-form-grid">
                    ...
                    <div class="ve-cms-field"><label for="subtitle">{{ $type === 'work' ? 'Subtitle' : 'Icon Class' }}</label><input id="subtitle" name="subtitle" value="{{ old('subtitle', $section->subtitle) }}" type="text"></div>
                    ...
                    <div class="ve-cms-field ve-cms-field-wide"><label for="content">Content</label><textarea id="content" name="content" rows="6">{{ old('content', $section->content) }}</textarea></div>
                    <div class="ve-cms-field ve-cms-field-wide"><label for="image">Image</label><input id="image" name="image" type="file" accept="image/*" data-image-preview="about-section-image-preview"><div id="about-section-image-preview" class="ve-cms-image-preview is-hidden"></div></div>
                </div>
                <div class="ve-cms-form-actions"><button type="submit" class="ve-btn-primary"><i class="fa fa-save"></i> Save About Item</button></div>
            </form>
        </section>
    </main>
